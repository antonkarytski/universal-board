...
export const TriangleRight = createBaseShape({
  name: '_triangleRight',
  draw: createTriangleDraw(right),
})

export const TriangleSymmetricVertical = createBaseShape({
  name: '_triangleSymmetricVertical',
  draw: createTriangleDraw(symmetricVertical),
})

export const TriangleSymmetricHorizontal = createBaseShape({
  name: '_triangleSymmetricVertical',
